...
**Immediate toast feedback on PDF analysis start (b384f89)**: Mock PDF analysis now shows a toast notification immediately when upload/re-analysis begins, providing user feedback even if they're scrolled down the page. When handling PDF analysis triggers, emit toast feedback synchronously before async parsing starts to improve perceived responsiveness.
...
**Mock PDF Q-by-Q format parsing (e4276c4)**: Enhanced mock PDF analysis to correctly classify all 90 questions by topic in Q-by-Q format exams, ensuring complete topic score extraction. When updating mock PDF parsing, handle both traditional and Q-by-Q formatted PDFs and verify all questions are categorized before score aggregation.


**What's New version rotation cleanup (latest)**: Removed versions 2026-07-18-d and 2026-07-19 from WHATS_NEW_SLIDES rotation. Added new versions 2026-07-19-e and 2026-07-19-f. Currently active versions are 2026-07-19-b, 2026-07-19-c, 2026-07-19-d, 2026-07-19-e, and 2026-07-19-f. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**What's New version rotation cleanup (latest)**: Removed versions 2026-07-18-c and 2026-07-18-d from WHATS_NEW_SLIDES rotation. Added new versions 2026-07-19-d and 2026-07-19-e. Currently active versions are 2026-07-19, 2026-07-19-b, 2026-07-19-c, 2026-07-19-d, and 2026-07-19-e. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.
...
**What's New version rotation cleanup (latest)**: Removed versions 2026-07-18 and 2026-07-18-b from WHATS_NEW_SLIDES rotation. Added new versions 2026-07-19-b and 2026-07-19-c. Currently active versions are 2026-07-18-c, 2026-07-18-d, 2026-07-18-e, 2026-07-19, 2026-07-19-b, and 2026-07-19-c. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**Client-side topic label normalization (4b81e56)**: Added normalization of topic labels on the client side during mock PDF analysis to ensure consistent mapping regardless of how topics are labeled in uploaded PDFs. When parsing mock exam results, apply label normalization before matching to canonical topic names to handle variations in CFA curriculum naming.


**What's New version rotation cleanup (latest)**: Removed versions 2026-07-18-f and 2026-07-18 from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-18-b, 2026-07-18-c, 2026-07-18-d, 2026-07-19, and 2026-07-19-b. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**What's New version rotation cleanup (latest)**: Removed versions 2026-07-18-e and 2026-07-18-f from WHATS_NEW_SLIDES rotation. Added new version 2026-07-18-d and 2026-07-19. Currently active versions are 2026-07-18, 2026-07-18-b, 2026-07-18-c, 2026-07-18-d, and 2026-07-19. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**Mock PDF re-analysis history replacement (2817ead)**: When users re-analyze a previously uploaded mock PDF, the new analysis result replaces the old history entry instead of creating a duplicate. When handling mock re-uploads, ensure history state updates the existing entry rather than appending to prevent duplicate analysis records.
...
**What's New version rotation cleanup (1ac8e4a)**: Removed versions 2026-07-18-c and 2026-07-18-d from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-18-e, 2026-07-18-f, 2026-07-18-b, and 2026-07-18. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**What's New version rotation cleanup (latest)**: Removed versions 2026-07-18-b and 2026-07-18-c from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-18-d, 2026-07-18-e, 2026-07-18-f, and 2026-07-18. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**Mock analysis real topic score extraction (7bb7898)**: Mock exam analysis now extracts real topic-level scores from mock results and displays Mock vs In-App accuracy side-by-side in Readiness Tracker. When updating mock performance calculations, ensure topic scores are properly parsed from mock data and matched to corresponding in-app modules for accurate comparative insights.


**What's New version rotation cleanup (latest)**: Removed versions 2026-07-18 and 2026-07-18-b from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-18-c, 2026-07-18-d, 2026-07-18-e, and 2026-07-18-f. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**Duplicate mock detection and multi-topic phase distribution (4bcc031)**: Fixed logic to prevent duplicate mock exams from being counted multiple times when distributing phases across topics. When updating mock-aware features or phase distribution, ensure mock uniqueness is validated before performance calculations to avoid inflated readiness scores.


**Exam Plan topic keyword matching expansion (b52eea1)**: Topic keyword matching now spans across all CFA subjects (Financial Reporting, Equity Analysis, Fixed Income, Derivatives, Alternative Investments, etc.) to improve Readiness Tracker accuracy. When updating keyword lists for topic matching, ensure comprehensive coverage across all Level I, II, III subjects to maintain consistent module-level performance correlation.


**What's New version rotation cleanup (b52eea1)**: Removed versions 2026-07-18-f and 2026-07-18 from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-18-b, 2026-07-18-c, 2026-07-18-d, and 2026-07-18-e. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.
...
**What's New version rotation cleanup (c8c500b)**: Removed versions 2026-07-18-d and 2026-07-18-e from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-18-f, 2026-07-18, 2026-07-18-c, and 2026-07-18-d. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**More menu streamlined to 8 items (10862e3)**: Trimmed More menu to 8 focused navigation items, removing redundant analytics entries. When updating the More menu, maintain focused scope and avoid duplicate feature links to reduce navigation clutter and improve UX clarity.


**Exam Plan Readiness Tracker module-level accuracy (61e8b00)**: Readiness Tracker now displays module-level mock vs in-app accuracy comparisons alongside pass probability trends. When updating Readiness Tracker, ensure accuracy metrics distinguish between official mock performance and in-app quiz results to help users prioritize high-impact study areas.


**What's New version rotation cleanup (61e8b00)**: Removed versions 2026-07-18-c and 2026-07-18-d from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-18-e, 2026-07-18-f, 2026-07-18-b, and 2026-07-18. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**What's New version rotation cleanup (04fdc66)**: Removed versions 2026-07-18 and 2026-07-18-b from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-18-c, 2026-07-18-d, 2026-07-18-e, and 2026-07-18-f. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**Exam Plan content tabs (04fdc66)**: Added Notes, Formulas, and Deep Study CTAs to Exam Plan tabs with mock-aware content rendering. When updating Exam Plan UI, ensure tab content reflects user's mock performance context and displays phase-specific study resources appropriate to current readiness level.
...
**What's New version rotation cleanup (latest)**: Removed versions 2026-07-18-e and 2026-07-18-f from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-18, 2026-07-18-b, 2026-07-18-c, and 2026-07-18-d. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.
...
**What's New version rotation cleanup (d7e9b64)**: Removed versions 2026-07-18-d and 2026-07-18-e from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-18-f, 2026-07-18-b, 2026-07-18-c, and 2026-07-18. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.
...
**Parallelize weighted mock generation to fix mobile network failures (c6cffcd)**: Mock exam generation now uses weighted parallelization to handle flaky mobile networks without dropping questions. When implementing parallel I/O for unreliable connections, use retry logic with weighted fallback strategies rather than simple fan-out to ensure delivery guarantees.


**What's New version rotation cleanup (bae89a3)**: Removed versions 2026-07-17-f, 2026-07-17, and 2026-07-17-b from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-18, 2026-07-18-b, and 2026-07-18-c. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**Event-driven loading screen with accurate step labels (bae89a3)**: Loading screen now uses event-driven step transitions instead of fixed timers, with softened retry logic for failed generation attempts. When implementing progress feedback, tie visual updates to actual generation milestones rather than elapsed time to improve perceived accuracy.


**What's New version rotation cleanup (latest)**: Removed versions 2026-07-17, 2026-07-17-e, and 2026-07-17-f from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-17-b, 2026-07-17-c, and 2026-07-17-d. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**Skeleton shimmer visibility fix (9c7a466)**: Fixed skeleton loading shimmer that was invisible in light mode by adjusting opacity and contrast. When implementing loading skeletons, test visibility across both light and dark themes to ensure feedback is perceivable in all contexts.


**What's New version rotation cleanup (latest)**: Removed versions 2026-07-17-d, 2026-07-17-e, and 2026-07-17-f from WHATS_NEW_SLIDES rotation. Currently active version is 2026-07-17. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**Energize color theme: midnight navy base, brighter accents, vibrant greens (9e41e23)**: Updated DARK_PALETTE with deeper midnight navy backgrounds (#0b0d1e), brighter accent blues (#6d74f8), and more vibrant greens (#22c55e). Light palette also refreshed with stronger success green (#16a34a). When maintaining or extending the color system, reference these new palette values to maintain visual consistency across new components.


**Demo quiz layout UX fixes (3466203)**: Fixed demo quiz layout issues, empty bottom spacing, and buried 'Try' CTA visibility to improve initial user experience. When designing onboarding flows, ensure demo content is prominently discoverable and layout doesn't obscure conversion funnels.


**3x faster mock generation via parallel question fan-out (3466203)**: Mock exam generation now parallelizes question creation across multiple API calls for significant speedup. This extends the earlier parallel fan-out optimization from quiz sessions to full mock exams. When implementing batch question generation, continue using controlled concurrency patterns.


**What's New version rotation cleanup (3466203)**: Removed versions 2026-07-17-c, 2026-07-17-d, and 2026-07-17-e from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-17-f, 2026-07-17-b, and 2026-07-18. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**What's New version rotation cleanup (4148c64)**: Removed versions 2026-07-17-b, 2026-07-17-c, and 2026-07-17-d from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-17, 2026-07-17-e, and 2026-07-17-f. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**Parallelized bottlenecks: full exam, session save, startup reads (4148c64)**: Full exam generation, session persistence, and startup data reads now use parallel execution for significant speedup. When implementing I/O-heavy operations, parallelize independent tasks rather than sequential execution to reduce perceived latency.
...
**Parallel fan-out question generation (3eb1e39)**: Question generation now uses parallel fan-out for 3x speedup on mock sessions. When implementing quiz generation at scale, use parallel API calls with controlled concurrency to accelerate multi-question batches rather than sequential generation.


**Token budget reduced to 380 (f8a4e05)**: Generation token budget lowered from 450 to 380 to optimize costs and generation speed. Background pre-warming added to reduce perceived latency. When implementing future optimizations, maintain this lower budget while monitoring question quality and session completion rates.


**What's New version rotation cleanup (f8a4e05)**: Removed versions 2026-07-17-f, 2026-07-17, and 2026-07-17-b from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-17-c, 2026-07-17-d, and 2026-07-17-e. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**What's New version rotation cleanup (latest)**: Removed versions 2026-07-17, 2026-07-17-e, and 2026-07-17-f from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-17-b, 2026-07-17-c, and 2026-07-17-d. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**Loading bar calibration to generation time (fdeca5e)**: Loading bar now uses tiered buffers based on actual generation time instead of fixed durations. When implementing progress indicators, dynamically adjust buffer timing to match observed API response patterns for more accurate UX feedback.


**What's New version rotation cleanup (latest)**: Removed versions 2026-07-17-d, 2026-07-17-e, and 2026-07-17-f from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-17, 2026-07-17-c, and 2026-07-17-d. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**Over-generate questions to guarantee requested session size (59991e5)**: Question generation now over-generates candidates and filters to guarantee the exact requested session size is delivered, preventing short sessions. When implementing quiz generation, ensure over-generation with filtering rather than relying on single-pass generation to meet session size guarantees.


**What's New version rotation cleanup (latest)**: Removed versions 2026-07-17-c, 2026-07-17-d, and 2026-07-17-e from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-17-f, 2026-07-17-b, and 2026-07-17-c. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.


**AI Next Action Diagnosis on results screen (7955224)**: Added diagnostic analysis to results screen showing actionable next steps after quiz completion. When designing post-quiz UX, surface AI-powered diagnoses that guide users toward targeted revision and progression decisions.


**Rate-limit wait messaging (16f634a)**: Added 7-minute wait indication for rate-limited API requests instead of failing silently. When handling API rate limits, surface expected wait times to users rather than generic errors.


**Silent short session handling (16f634a)**: Sessions shorter than a defined minimum threshold (e.g., <3 questions) no longer trigger analytics or logging. When implementing session tracking, respect minimum session length thresholds to avoid noise from incomplete or trivial sessions.


**Duplicate question prevention (16f634a)**: Implemented deduplication logic to prevent the same question from appearing multiple times in a quiz session. When generating quiz questions, ensure questions are tracked and filtered to avoid repeats within a single session.


**What's New version rotation cleanup (16f634a)**: Removed versions 2026-07-17-b, 2026-07-17-c, and 2026-07-17-d from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-17, 2026-07-17-e, and 2026-07-17-f. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.
...
**What's New version rotation cleanup (6966246)**: Removed versions 2026-07-17-f and 2026-07-17-b from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-17-c, 2026-07-17-d, and 2026-07-17-e. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.
...
**Easy difficulty prompt sharpened (33ee6a2)**: Easy difficulty question generation across all three CFA levels now uses more rigorous prompts to ensure foundational questions remain appropriately accessible while maintaining quality. When tuning question generation, maintain this baseline rigor for easy difficulty to ensure consistent quality progression across all difficulty tiers.
...
**What's New version rotation (6744d25)**: Removed versions 2026-07-17-b, 2026-07-17-c, and 2026-07-17-d from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-17-e and 2026-07-17-f. When rotating slides, verify the complete active list and clean up obsolete versions to prevent duplicate announcements.
...
**AI debrief step-by-step revision→drill flow (7fbcfb7)**: AI debrief now implements structured guidance walking users from understanding mistakes through targeted drills. When designing post-quiz feedback, scaffold from gap identification → drill sequencing → confidence building before retest.


**What's New version 2026-07-17-b and 2026-07-17-c (2026-07-17)**: New slide sets announcing AI Debrief guided review flow, Results Screen stability improvements, and Question Validation enhancements. Versions 2026-07-13-f, 2026-07-13, 2026-07-14, 2026-07-14-a have been removed from rotation. Currently active versions are 2026-07-14-b, 2026-07-17, 2026-07-17-b, and 2026-07-17-c.


**What's New version 2026-07-17 (2026-07-17)**: New slide set announcing Results & Practice Screens stability improvements. Currently active versions are 2026-07-14 and 2026-07-17. Versions 2026-07-13-e, 2026-07-13-f, and 2026-07-13 have been removed from rotation.


**Back navigation from Revision to Results (f791f1d)**: Fixed navigation flow so users can return from Revision screen to Results screen without losing context. When designing multi-screen flows with back buttons, ensure screen state is properly restored and navigation paths are bidirectional.


**Gap history tracking (7fbcfb7)**: New `GAP_HISTORY_KEY` constant stores knowledge gap data from failed questions. Gap memory tracks which concepts users struggle with, enabling pass impact metrics and spaced repetition targeting. When implementing revision or drill flows, reference gap history to personalize content toward weak areas.
...
**What's New version 2026-07-14 (2026-07-14)**: New slide set announcing Results Screen stability fix. Currently active versions are 2026-07-13-d, 2026-07-13-e, 2026-07-13-f, 2026-07-13, and 2026-07-14. Versions 2026-07-13-b and 2026-07-13-c have been removed from rotation.
...
**What's New version 2026-07-13-e (2026-07-13)**: New slide set announcing Stay Connected After Signup (email validation, push notifications) and More Accurate Question Grading (approximation symbol fix). Currently active versions include 2026-07-13, 2026-07-13-b, 2026-07-13-c, 2026-07-13-d, and 2026-07-13-e. Versions 2026-07-12-b and 2026-07-12-c have been removed from rotation.


**PostHog project token configuration (b71131a)**: PostHog analytics now wired with project token for production tracking. When initializing analytics, ensure PostHog token is configured in environment to enable event capture and user identification. Graceful degradation already in place via try-catch blocks in `ph` helper.


**Post-signup engagement flow (addc5a7)**: New system tracks email validation, push opt-in, and drip emails after user signup. Session stores activation state to personalize onboarding messaging and re-engagement campaigns. When designing post-signup flows, leverage email validation and push subscription status to determine which engagement tier messaging to display.


**What's New version 2026-07-13-d (2026-07-13)**: New slide set covering Accurate Answer Validation (≈ bypass fix), Progress Tracking fixes, and Better Learning Insights. Currently active versions are 2026-07-12-c, 2026-07-12-d, 2026-07-12-e, 2026-07-13, 2026-07-13-b, 2026-07-13-c, and 2026-07-13-d. Versions 2026-07-12 and 2026-07-12-b have been removed from rotation.


**What's New version consolidation (3ae77ad)**: Removed 2026-07-12 and 2026-07-12-f from WHATS_NEW_SLIDES rotation. Currently active versions are 2026-07-12-b, 2026-07-12-c, 2026-07-12-d, 2026-07-12-e, 2026-07-13, 2026-07-13-b, and 2026-07-13-c. Always verify active list when adding new versions to prevent duplicate messaging.


**What's New version 2026-07-13-c (2026-07-13)**: New slide set announcing Accurate Question Validation, Mock Exam Progress Tracking, and Personalized Study Engagement Features. Currently active versions are 2026-07-13, 2026-07-13-b, and 2026-07-13-c. Versions 2026-07-12 and 2026-07-12-f have been removed from rotation.


**PostHog analytics instrumentation (3ae77ad)**: Added `ph` helper object for PostHog analytics capture. Wraps `window.posthog?.capture(event, properties)`, `identify(id, traits)`, and `reset()` in try-catch blocks to safely handle missing PostHog library. When instrumenting user actions, use `ph.capture()` for event tracking and `ph.identify()` for user property updates to ensure graceful degradation if PostHog is unavailable.
...
**What's New version 2026-07-13 (2026-07-13)**: New consolidated slide set announcing Authentic CBT Mock Exams, Re-engagement Nudges, AI Study Notes Generator, and Web Push Notifications. Currently active versions are 2026-07-12, 2026-07-12-b, 2026-07-12-c, and 2026-07-13. Always verify against active list when adding future versions to prevent duplicate messaging.
...
**Mock PDF Q-by-Q format classification (e4276c4)**: Mock PDF parser now classifies all 90 questions by topic when analyzing Q-by-Q format PDFs. When handling question-by-question mock results, ensure the classification engine maps all questions to their corresponding CFA topics before computing aggregate topic scores.
