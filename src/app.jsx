...
const OFFLINE_SEED_QS = {
  ...
  "Quantitative Methods": {"Time Value of Money": [
    ...
    {id:"s_qm_4",question:"If P(A) = 0.40 and P(B|A) = 0.25, the joint probability P(A and B) is:",options:{A:"0.10",B:"0.15",C:"0.625"},answer:"A",explanation:"Correct: A. The multiplication rule states P(A and B) = P(A) × P(B|A) = 0.40 × 0.25 = 0.10. P(B|A) is the conditional probability of B given A has occurred."},
    {id:"s_qm_5",question:"A Type I error in hypothesis testing occurs when the analyst:",options:{A:"Fails to reject a false null hypothesis",B:"Rejects a true null hypothesis",C:"Sets the significance level too low"},answer:"B",explanation:"Correct: B. A Type I error (false positive) means rejecting H₀ when it is actually true. Its probability equals the significance level (α). A Type II error is failing to reject a false H₀."},
    {id:"s_qm_6",question:"In a simple linear regression Y = b₀ + b₁X + ε, the coefficient b₁ is best interpreted as:",options:{A:"The expected value of Y when X equals zero",B:"The expected change in Y for a one-unit increase in X",C:"The proportion of variance in Y explained by X"},answer:"B",explanation:"Correct: B. b₁ is the slope — the marginal effect of X on Y. b₀ is the intercept (Y when X=0). R² measures the proportion of variance in Y explained by the model."},
  ]},
  "Economics": {"Firm & Market Structures": [
    ...
    {id:"s_ec_4",question:"Which component of GDP measures expenditures by households on goods and services?",options:{A:"Investment (I)",B:"Government spending (G)",C:"Consumption (C)"},answer:"C",explanation:"Correct: C. GDP = C + I + G + (X − M). Consumption (C) is household spending on final goods and services, typically the largest component of GDP in developed economies."},
    {id:"s_ec_5",question:"When a central bank raises the policy interest rate, the most direct initial effect is:",options:{A:"Depreciation of the domestic currency",B:"Reduced borrowing and spending, slowing aggregate demand",C:"An increase in the money supply through open market operations"},answer:"B",explanation:"Correct: B. Higher policy rates raise the cost of borrowing, discouraging consumer credit and business investment, which reduces aggregate demand. Currency appreciation (not depreciation) is the typical exchange rate effect."},
    {id:"s_ec_6",question:"Relative Purchasing Power Parity (PPP) predicts that exchange rates will adjust to reflect differences in:",options:{A:"Real GDP growth rates between countries",B:"Inflation rate differentials between countries",C:"Interest rate differentials between countries"},answer:"B",explanation:"Correct: B. Relative PPP states that the rate of exchange rate change equals the inflation differential. The country with higher inflation sees its currency depreciate. Interest rate differentials relate to covered/uncovered interest rate parity."},
  ]},
  "Financial Statement Analysis": {"Income Statement Analysis": [
    ...
    {id:"s_fsa_4",question:"Under the indirect method of the cash flow statement, depreciation is added back to net income because it is:",options:{A:"A source of cash from operations",B:"A non-cash charge that reduced net income but did not use cash",C:"Classified as a financing activity"},answer:"B",explanation:"Correct: B. Depreciation reduces net income but involves no cash outflow. The indirect method starts with net income and reverses non-cash items; depreciation is added back to convert to cash basis."},
    {id:"s_fsa_5",question:"A firm using FIFO in a period of rising prices compared to a LIFO firm will report:",options:{A:"Higher COGS and lower net income",B:"Lower COGS, higher net income, and higher inventory",C:"The same net income because total cash flows are unaffected"},answer:"B",explanation:"Correct: B. With rising prices, FIFO assigns older (cheaper) costs to COGS, resulting in lower COGS, higher gross profit, and higher inventory on the balance sheet compared to LIFO."},
    {id:"s_fsa_6",question:"A deferred tax liability arises when:",options:{A:"Tax expense exceeds taxes payable because income is recognised later for tax purposes",B:"Taxable income is higher than accounting income in the current period",C:"A company has operating loss carryforwards that reduce future taxes"},answer:"A",explanation:"Correct: A. A DTL means the firm has already recognised income in its financial statements but will pay the tax later (tax timing difference). Accelerated depreciation for tax purposes is a classic example."},
  ]},
  "Corporate Issuers": {"Capital Structure & Leverage": [
    ...
    {id:"s_ci_4",question:"Under the Modigliani-Miller dividend irrelevance theorem (no taxes, perfect markets), the value of a firm:",options:{A:"Increases with a higher dividend payout because investors prefer current income",B:"Is unaffected by dividend policy because investors can create homemade dividends",C:"Decreases with higher dividends because retained earnings are more valuable"},answer:"B",explanation:"Correct: B. MM dividend irrelevance holds that investors are indifferent — if the firm pays dividends, they can be reinvested; if not, investors sell shares for cash (homemade dividends). Value is determined by investment policy, not payout."},
    {id:"s_ci_5",question:"A firm's cash conversion cycle (CCC) measures:",options:{A:"The time from paying for inventory to collecting cash from customers",B:"Days payable outstanding minus days sales outstanding",C:"The number of days to convert fixed assets into revenue"},answer:"A",explanation:"Correct: A. CCC = DSO + DIO − DPO. It measures the net days of working capital tied up in operations — from cash outflow to purchase inventory until cash inflow from customers. A shorter CCC improves liquidity."},
    {id:"s_ci_6",question:"Agency costs of equity arise primarily from conflicts between:",options:{A:"Shareholders and bondholders over risk-taking",B:"Managers and shareholders when interests diverge",C:"Firms and their customers over pricing"},answer:"B",explanation:"Correct: B. Agency costs occur when managers (agents) act in their own interests rather than shareholders' (principals). Examples include excessive perquisites, empire building, or risk aversion. Aligning incentives via equity compensation reduces these costs."},
  ]},
  ...
  "Derivatives": {"Derivative Features & Markets": [
    ...
    {id:"s_de_4",question:"Put-call parity states that for European options with the same underlying, strike, and expiry:",options:{A:"Call price + PV(strike) = Put price + Spot price",B:"Call price − Put price = Spot price − PV(strike)",C:"Call price + Put price = Spot price + PV(strike)"},answer:"B",explanation:"Correct: B. Put-call parity: C − P = S₀ − PV(X), or equivalently C + PV(X) = P + S₀. A violation creates a riskless arbitrage. The relationship holds for European options on non-dividend-paying assets."},
    {id:"s_de_5",question:"In a plain-vanilla interest rate swap, the fixed-rate payer benefits when:",options:{A:"Interest rates fall, because the fixed payment obligation decreases",B:"Interest rates rise, because the floating rate received increases while fixed paid is unchanged",C:"The yield curve inverts, because short rates exceed long rates"},answer:"B",explanation:"Correct: B. The fixed-rate payer receives a floating rate and pays fixed. When rates rise, the floating leg received increases, while the fixed leg paid stays constant — a net gain. Falling rates have the opposite effect."},
    {id:"s_de_6",question:"Compared to forward contracts, futures contracts differ in that futures are:",options:{A:"More customisable to specific needs of counterparties",B:"Marked to market daily with margin accounts held at the clearinghouse",C:"Subject to greater counterparty default risk"},answer:"B",explanation:"Correct: B. Futures are standardised exchange-traded contracts settled daily via mark-to-market. This daily settlement and the clearinghouse as counterparty eliminates counterparty risk. Forwards are OTC, customisable, and settled at expiry."},
  ]},
  "Alternatives": {"Alternative Investment Features": [
    ...
    {id:"s_al_4",question:"The capitalisation rate (cap rate) for direct real estate is most accurately described as:",options:{A:"Net Operating Income divided by property value",B:"Gross rental income divided by total purchase price",C:"Cash flow after financing divided by equity invested"},answer:"A",explanation:"Correct: A. Cap rate = NOI / Property Value. NOI is income after operating expenses but before debt service. The cap rate is used to estimate value (Value = NOI / Cap rate) and to compare properties; lower cap rates imply higher valuations."},
    {id:"s_al_5",question:"Venture capital (VC) investments are best characterised as:",options:{A:"Investments in established mature companies with predictable cash flows",B:"Financing provided to early-stage companies with high growth potential and uncertain outcomes",C:"Debt financing secured by the assets of the target company"},answer:"B",explanation:"Correct: B. VC funds invest in early-stage, high-growth companies — typically pre-revenue or pre-profit. Returns are highly uncertain but asymmetric; a few successful exits (IPOs or acquisitions) drive most of the fund's return."},
    {id:"s_al_6",question:"Commodities are most commonly added to a portfolio to provide:",options:{A:"Stable income through regular dividend or coupon payments",B:"Protection against inflation, since commodity prices tend to rise with the price level",C:"Credit risk diversification, since commodities are uncorrelated with bonds"},answer:"B",explanation:"Correct: B. Commodity prices are driven partly by input costs and tend to rise with inflation. Their low or negative correlation with stocks and bonds also provides diversification. However, commodities generate no income — they are total-return assets."},
  ]},
  "Portfolio Management": {"Portfolio Risk & Return": [
    ...
    {id:"s_pm_4",question:"The efficient frontier represents portfolios that:",options:{A:"Have the highest return for any given level of risk",B:"Minimise risk for any given level of expected return",C:"Both A and B — portfolios that are both return-maximising and risk-minimising"},answer:"C",explanation:"Correct: C. A portfolio is efficient if no other portfolio offers higher expected return for the same risk OR lower risk for the same expected return. The efficient frontier is the upper-left boundary of the minimum-variance frontier."},
    {id:"s_pm_5",question:"The Sharpe ratio measures:",options:{A:"Excess return per unit of total risk (standard deviation)",B:"Excess return per unit of systematic risk (beta)",C:"Return relative to a benchmark portfolio"},answer:"A",explanation:"Correct: A. Sharpe ratio = (Portfolio return − Risk-free rate) / Portfolio standard deviation. It uses total risk, making it appropriate when the portfolio is not well-diversified. The Treynor ratio uses beta (systematic risk) instead."},
    {id:"s_pm_6",question:"Strategic asset allocation differs from tactical asset allocation in that strategic allocation:",options:{A:"Is adjusted frequently to exploit short-term market mispricings",B:"Establishes long-run target weights consistent with the investor's policy objectives",C:"Focuses on selecting individual securities within each asset class"},answer:"B",explanation:"Correct: B. Strategic asset allocation sets long-term target weights based on the investor's IPS — return objectives, risk tolerance, and constraints. Tactical allocation makes short-term deviations from those targets to capitalise on perceived mispricings."},
  ]},
};
...
{emoji:"🎯",color:C.hard,bg:C.hard,title:"CBT-Authentic Mock Exams",sub:"Study Tools · 2026-07-12 update",desc:"Full timed mock exams now replicate the actual CFA computer-based testing experience, with tools hidden during the exam and accurate question counts per level. This trains you under real exam conditions so you arrive confident and practiced.",tip:"Start a mock exam and notice the stripped-down interface—just you and the questions, just like test day."},
{emoji:"📊",color:C.reward,bg:C.reward,title:"Post-Exam Review & Pacing",sub:"Study Tools · 2026-07-12 update",desc:"After completing a mock exam, review your answers and see detailed pacing breakdowns to identify time management gaps. Understanding where you spent (or lost) time helps you refine strategy before the real exam.",tip:"Check the pacing report after your next mock to spot which topic areas are eating up your time."},
]},
// WN_END
];
    ...
    {studyGroup?(
      <div>
        ...
        <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"16px",marginBottom:14}}>
          ...
          {groupLeaderboard.length>0?groupLeaderboard.map((m,i)=>(
            ...
            <div style={{textAlign:"center",padding:"18px 0"}}>
              ...
              <div style={{fontSize:13,fontWeight:600,color:C.text,marginBottom:3}}>Be the first to study this week!</div>
              <div style={{fontSize:11,color:C.muted}}>Complete a practice session to appear on the leaderboard.</div>
            </div>
          )}
        </div>
